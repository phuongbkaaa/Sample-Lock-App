...
import static com.utility.digitaldetox.StartPlanService.CHANNEL_ID;
...
public class OpenSettingsService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
         ...
         */
        intentToStart.putExtra(timePickerActivity.UNIQUE_ID, "OpenSettingsService");
        ...
        checkIfPermissionGranted= new CountDownTimer(200000, 1000) {
            ...
            public void onTick(long l) {
                ...
                if(mode == MODE_ALLOWED) {
                    ...
                    intentToOpenAppAgain.putExtra(timePickerActivity.UNIQUE_ID, "OpenSettingsService");
